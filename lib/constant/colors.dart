...
class ColorsProvider {
  static Color PRIMARY_COLOR = const Color(0xff3C8469);
  static Color UNSELECTED_COLOR = const Color(0xff666666);
  static Color APPBAR_BG_COLOR = const Color(0xffF8F8F8);
